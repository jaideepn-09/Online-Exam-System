	...
	<form id="form1">
				...
				<div class="carousel-item">
					...
					<div class="container">
						<div class="carousel-caption">
							<h1>
								<b>Efficient and Reliable.</b>
							</h1>
							<p>An Efficient and a Reliable tool to conduct Online
								Examinations.</p>
							<p>
								<a class="btn btn-lg btn-primary" href="about.jsp" role="button">Learn
									more</a>
							</p>
						</div>
					</div>
					...
					<div class="container">
						<div class="carousel-caption text-right">
							...
							<p>A Clean and an Elegant User Interface with Minimal
								Complexities.</p>
							<p>
								<a class="btn btn-lg btn-primary" href="login.jsp" role="button">Start
									Exam</a>
							</p>
						</div>
					</div>
		...
		<div class="container-fluid padding">
			<div class="row welcome text-center">
				...
				<hr />
				<div class="col-12">
					<p class="lead">An Online Examination Tool that allows for the
						swift, efficient and smooth conduction of college and university
						exams.</p>
				</div>
			</div>
		</div>
